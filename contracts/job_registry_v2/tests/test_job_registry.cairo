...
fn deploy_job_registry(owner: ContractAddress, token_address: ContractAddress) -> ContractAddress {
    let contract = declare("JobRegistryV2").unwrap().contract_class();
...
#[cfg(test)]
mod tests {
    use galaxyrend_job_registry_v2::job_registry_v2::{
        IJobRegistryV2Dispatcher, IJobRegistryV2DispatcherTrait,
    };
    use super::*;
    ...
    fn test_create_job_success() {
        ...
        let job_registry = IJobRegistryV2Dispatcher { contract_address: job_registry_address };
