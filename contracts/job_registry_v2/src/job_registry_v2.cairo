// GalaxyRend Job Registry with OpenZeppelin Integration
use starknet::ContractAddress;

// Interface representing the Job Registry contract.
#[starknet::interface]
pub trait IJobRegistryV2<TContractState> {
...
mod JobRegistryV2 {
    ...
    #[abi(embed_v0)]
    impl JobRegistryImpl of IJobRegistryV2<ContractState> {
        fn create_job(
