...
┌────────────────────┐    
| Backend(Fastapi)   |    ┌─────────────────┐    ┌─────────────────┐
│ Frontend(Next.js)  │    │ Smart Contract  │    │     Worker      │
│ Blender(Addon)     │◄──►│   (Starknet)    │◄──►│   (Python)      │
└────────────────────┘    └─────────────────┘    └─────────────────┘
         │                       │                       │
         │                       │                       │
         ▼                       ▼                       ▼
...
The Blender addon is a simple UI that allows you to submit .blend files to the GalaxyRend network.
https://github.com/RichoKD/GalaxyRend_addon
